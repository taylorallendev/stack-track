...
export default function SignUpPage() {
  ...
  // Handle OAuth sign-up with Apple
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // If email verification is not required, set the session as active
      ...
      if (
        ...
        clerkError.errors.forEach((err: ClerkError) => {
          if (err.meta?.paramName === "emailAddress") {
      ...
      <div className={cn("flex flex-col gap-6")}>
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Sign up with your account or email
            </CardDescription>
          </CardHeader>
          <CardContent>
